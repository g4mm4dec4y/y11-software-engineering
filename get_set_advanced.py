...
#Adding 2 more animals
p4 = Pet('Woof', 'Dog', 'German Shepherd', 8)
p5 = Pet('Maggie', 'Cat', 'Sphynx', 5)


pets = [p1,p2,p3,p4,p5]

#Function increases the age attribute by 1
def set_age(self):
    self.age += 1
#Increases the age for all the pets
for pet in pets:
    set_age(pet)

#Only prints the objects wiht the dog category attribute in the pet list
for pet in pets:
